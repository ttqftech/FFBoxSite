	...
	// 	appStore.selectedPanelIndex = 3;
		...
		if (!appStore.termsAgreed) {
			...
			Msgbox({
				...
				buttons: [
					{ text: `我已知悉，继续`, type: ButtonType.Primary, callback: () => window.open('./online-v5.4', '__blank') && true },
				]
			});
		}
	} else if (index === 4) {
...
<template>
	<div class="mainFrame" :data-color_theme="appStore.colorTheme">
		<div class="topBar">
			...
			<a class="nav" style="float: right;" href="https://qm.qq.com/cgi-bin/qm/qr?k=Bp-Vt0jNsRg7Y9p5FfpKsCWT7uh8VncK&jump_from=webapi&authKey=Mll2r3tjBMCwvFF8TPwMd/uAz9M6U9g25ecc7sLmf+DkONQBAV9on6E56xfbRI/G" target="_blank" title="FFBox 吐槽催更群">
